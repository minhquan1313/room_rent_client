...
import RoomAddLazy from "@/Components/LazyComponent/RoomAddLazy";
      ...
      <MyErrorBoundary>
        <Routes>
          ...
          <Route path="/" element={<MyLayout />}>
            ...
            {/* Only authentic user may access these routes */}
            {user && (
              <>
                {/* Admin routes start */}
                <Route
                ...
                >
                  ...
                  <Route
                    path={routeAdmin.user}
                    element={<UserDashBoardLazy />}
                  />
                ...
                <Route
                  path={`${routeRoomDetail}/:id`}
                  element={<RoomDetailLazy />}
                />
